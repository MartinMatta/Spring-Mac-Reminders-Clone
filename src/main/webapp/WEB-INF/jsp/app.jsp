...
<head>
	...
	<script>
                ...
                const color = urlParams.get('sort');

                if (color == 'today') {
                    $("h1.today").addClass("block")
                }
	...
	<div class="app">
		...
		<aside>
			...
			<nav>
				...
				<a href="?sort=scheduled" class="scheduled">
					<p>
						<svg>
							<path
				...
				<a href="?sort=flagged" class="flagged">
					<p>
						<svg>
							<path
